...
class Books extends Component {
  ...
  drawBooks(){
    var bookSection1 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/covers/1.jpg" alt="book1" className="bookCoverImage"/>
      ...
      <ul className="list-inline">
        <li><a href="https://www.aladin.co.kr/shop/wproduct.aspx?ISBN=8970504745&start=pnaver_02" target="_blank"  rel="noreferrer">
          <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/stores/aladdin.png" className="bookStoreIcon" alt="aladin"/></a></li>
        <li><a href="http://www.kyobobook.co.kr/product/detailViewKor.laf?mallGb=KOR&ejkGb=KOR&linkclassName=&barcode=9788970504742" target="_blank"  rel="noreferrer">
          <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/stores/kyobo.png" className="bookStoreIcon" alt="kyobo"/></a></li>
        <li><a href="https://book.naver.com/bookdb/book_detail.nhn?bid=17665326" target="_blank"  rel="noreferrer">
          <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/stores/naver.png" className="bookStoreIcon" alt="naver"/></a></li>
        <li><a href="http://www.yes24.com/Product/Goods/96360166" target="_blank"  rel="noreferrer">
          <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/stores/yes24.png" className="bookStoreIcon" alt="yes24"/></a></li>
      </ul>
    </div>

    var bookSection2 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/covers/2.jpg" alt="book2" className="bookCoverImage"/>
      <h5>공학자의 오경묵상</h5>
    ...
    var bookSection3 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/covers/3.jpg" alt="book3" className="bookCoverImage"/>
      <h5>공학자의 지혜묵상</h5>
    ...
    var bookSection4 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/covers/4.jpg" alt="book4" className="bookCoverImage"/>
    ...
    var bookSection5 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/covers/5.jpg" alt="book5" className="bookCoverImage"/>
      <h5>법대로 합시다</h5>
    ...
    var bookSection6 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/covers/6.jpg" alt="book6" className="bookCoverImage"/>
      <h5>실전 민사소송법</h5>
      <p className="bookDescription">2020.05. BOOKK(부크크)</p>
      <ul className="list-inline">
    ...
    var bookSection7 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/covers/7.jpg" alt="book7" className="bookCoverImage"/>
      <h5>코딩하는 공익</h5>
    ...
    var bookSection8 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/covers/8.jpg" alt="book8" className="bookCoverImage"/>
    ...
    var bookSection9 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/covers/9.jpg" alt="book9" className="bookCoverImage"/>
      ...
      <ul className="list-inline">
        ...
        <li><a href="https://book.naver.com/bookdb/book_detail.nhn?bid=20764734" target="_blank"  rel="noreferrer">
          ...
          <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/stores/ridi.jpg" className="bookStoreIcon" alt="ridibooks"/></a></li>
      </ul>
    </div>
    
    var bookSection10 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/covers/10.jpg" alt="book10" className="bookCoverImage"/>
    ...
    var bookSection11 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/covers/11.jpeg" alt="book11" className="bookCoverImage"/>
    ...
    var bookSection12 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/covers/12.jpg" alt="book12" className="bookCoverImage"/>
    ...
    var bookSection13 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/covers/13.jpg" alt="book12" className="bookCoverImage"/>
    ...
    var bookSection14 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/covers/14.jpg" alt="book12" className="bookCoverImage"/>
    ...
    var bookSection15 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/covers/15.jpg" alt="book12" className="bookCoverImage"/>
    ...
    var bookSection16 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/ai_voca/src/images/books/covers/16.png" alt="book12" className="bookCoverImage"/>
